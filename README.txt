...
5. Order history from latest date descending order
6. Add a search feature on History table
7. Add a 'Tag' or 'Label' field to Meeting page - this will enable the grouping of meetings
8. Need to add a 'remove account/profile' feature
